...
export default class LoggerModule extends BaseModule implements ICoreModule {
     ...
     * @param tag String Log tag
     */
    public info(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public debug(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public warn(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public error(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public http(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public verbose(log: string | object, tag?: string): string {
     ...
     * @param tag String Log tag
     */
    public silly(log: string | object, tag?: string): string {
